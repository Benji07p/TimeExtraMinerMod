...
public abstract class OxygenFluid extends ForgeFlowingFluid {
	public static final ForgeFlowingFluid.Properties PROPERTIES = new ForgeFlowingFluid.Properties(TimeextraminerModFluids.OXYGEN,
			TimeextraminerModFluids.FLOWING_OXYGEN,
			FluidAttributes.builder(new ResourceLocation("timeextraminer:blocks/oxygen"), new ResourceLocation("timeextraminer:blocks/oxygen"))

	).explosionResistance(100f)

			.bucket(TimeextraminerModItems.OXYGEN_BUCKET).block(() -> (LiquidBlock) TimeextraminerModBlocks.OXYGEN.get());
