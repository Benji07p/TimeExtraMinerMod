...
public abstract class AmmoniaFluid extends ForgeFlowingFluid {
	public static final ForgeFlowingFluid.Properties PROPERTIES = new ForgeFlowingFluid.Properties(TimeextraminerModFluids.AMMONIA,
			TimeextraminerModFluids.FLOWING_AMMONIA,
			FluidAttributes.builder(new ResourceLocation("timeextraminer:blocks/ammonia"), new ResourceLocation("timeextraminer:blocks/ammonia"))

	).explosionResistance(100f)

			.bucket(TimeextraminerModItems.AMMONIA_BUCKET).block(() -> (LiquidBlock) TimeextraminerModBlocks.AMMONIA.get());
