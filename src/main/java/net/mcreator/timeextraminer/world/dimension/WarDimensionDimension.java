...
package net.mcreator.timeextraminer.world.dimension;
...
public class WarDimensionDimension {
	...
	public static class Fixers {
		...
		public static void registerDimensionSpecialEffects(FMLClientSetupEvent event) {
			...
			event.enqueueWork(() -> DimensionSpecialEffects.EFFECTS.put(new ResourceLocation("timeextraminer:time_dimension"), customEffect));
		}
	}
}
